...
class AddAccountKjwPage extends StatefulWidget {
  const AddAccountKjwPage({
    Key? key,
    this.accountId,
  }) : super(key: key);
  ...
  @override
  AddAccountKjwPageState createState() => AddAccountKjwPageState();
}

class AddAccountKjwPageState extends State<AddAccountKjwPage> {
            ...
            return ScreenTypeLayout(
              mobile: Scaffold(
                appBar: context.materialYouAppBar(
                  isAccountAddOrUpdate
                      ? '${context.loc.addAccount}kjw'
                      : '${context.loc.updateAccount}kjw',
                  actions: [
